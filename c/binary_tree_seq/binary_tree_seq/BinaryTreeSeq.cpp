...
typedef struct
{
	// Level of nodes, serial number of this level
	int level, order;
}Position;
...
int main()
{
	...
	printf("Preorder:\n");
	PreOrderTraverse(T);
	printf("Node %d's parents are %d, left and right child are ", e, Parent(T, e));
	printf("%d,%d,left and right siblings are ", LeftChild(T, e), RightChild(T, e));
